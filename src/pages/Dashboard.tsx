...
import { Upload, ArrowLeft, ChevronLeft, ChevronRight, Database, Package, GraduationCap } from "lucide-react";
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <Button variant="outline" size="sm" onClick={() => navigate("/training")} className="gap-2">
                <GraduationCap className="h-4 w-4" />
                Training
              </Button>
              <Button variant="outline" size="sm" onClick={() => navigate("/datamanagement")} className="gap-2">
